...
const UserDropDown = ({ locale }) => {
  ...
  <div
    ...
    className={`fixed inset-0 flex items-center justify-center bg-gray-900 bg-opacity-50 transition-opacity duration-300 ease-in-out ${
  ...
  >
    ...
    >
      {/* Left Section */}
      <div className="flex flex-col justify-center bg-gray-900 text-white w-full md:w-1/2 p-8 md:p-12">
        <h1 className="text-3xl md:text-4xl font-bold mb-4 md:mb-6">
          Welcome to
          <br />
          <strong>ENVY.ME</strong>
        </h1>
